    ...
    echo '<div id="product-comparison-woocommerce-welcome-notice" class="notice notice-success is-dismissible welcome-notice">';
        echo '<div class="notice-row">';
            echo '<div class="notice-text">';
                ...
                echo '<span class="bundle-btn"><a href="' . esc_url('https://www.vwthemes.com/products/wp-theme-bundle') . '" class="button button-primary" target="_blank">' . esc_html__('BUNDLE OF 485+ THEMES', 'product-comparison-woocommerce') . '</a></span>';
            echo '</div>';
