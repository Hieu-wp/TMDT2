...
function formula_menucart( $menu, $args ) {
		...
		if ( ! in_array( 'woocommerce/woocommerce.php', apply_filters( 'active_plugins', get_option( 'active_plugins' ) ) ) || 'primary' !== $args->theme_location ) {
			...
			if ( $cart_contents_count == 0 ) {
				$menu_item = '<div class="shopping-cart menu-item"><a class="wcmenucart-contents cart-icon" href="' . $shop_page_url . '" title="' . $start_shopping . '">';
			} else {
				$menu_item = '<div class="shopping-cart menu-item"><a class="wcmenucart-contents cart-icon" href="' . $cart_url . '" title="' . $viewing_cart . '">';
			}
