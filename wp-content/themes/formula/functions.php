...
{
	// Formula Css.
	wp_enqueue_style('inter-fonts', 'https://fonts.googleapis.com/css2?family=Inter:wght@100;200;300;400;500;600;700;800;900&display=swap');
	...
	wp_enqueue_script('appear-min', FORMULA_THEME_URL . '/assets/vendors/jquery-appear/jquery.appear.min.js', array('jquery'), FORMULA_THEME_VERSION, true);
	wp_enqueue_script('easing-min', FORMULA_THEME_URL . '/assets/vendors/jquery-easing/jquery.easing.min.js', array('jquery'), FORMULA_THEME_VERSION, true);
	wp_enqueue_script('bootstrap-bundle-min', FORMULA_THEME_URL . '/assets/vendors/bootstrap/js/bootstrap.bundle.min.js', array('jquery'), FORMULA_THEME_VERSION, true);

	// Animation Js.
	if (get_theme_mod('formula_animation_disabled', true) == true):
		wp_enqueue_script('wow', FORMULA_THEME_URL . '/assets/vendors/wow/wow.js', array('jquery'), FORMULA_THEME_VERSION, true);
	endif;

	wp_enqueue_script('owl-carousel-min', FORMULA_THEME_URL . '/assets/vendors/owl-carousel/owl.carousel.min.js', array('jquery'), FORMULA_THEME_VERSION, false);
	wp_enqueue_script('odometer-min', FORMULA_THEME_URL . '/assets/vendors/odometer/odometer.min.js', array('jquery'), FORMULA_THEME_VERSION, true);
	wp_enqueue_script('formula-main', FORMULA_THEME_URL . '/assets/js/formula.js', array('jquery', 'owl-carousel-min'), FORMULA_THEME_VERSION, true);
